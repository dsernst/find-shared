...
export const Footer = () => {
  ...
  return (
    <footer className="row-start-2 flex flex-col items-center justify-center gap-3">
      <p className="text-center text-sm text-white/50">100% peer-to-peer. No DB, nothing saved</p>
